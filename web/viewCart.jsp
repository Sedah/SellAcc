  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
            ...
            <div class="row">
              <div class="col-sm-12">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="hidden-xs"><img src="${acc.image}" alt="${acc.name}"/></td>
                      <td>
                        <h5 class="product-title font-alt">${acc.name}</h5>
                      </td>
                      <td class="hidden-xs">
                      ...
                      <td>
                        ...
                        <h5 class="product-title font-alt">${acc.amount}</h5>
                      </td>
                      </td>
                      <td>
                        <h5 class="product-title font-alt">${acc.amount}</h5>
             ...
             <div class="row">
              ...
              <c:if test="${sessionScope.username != null}">
               ...
               <h3> Use Point</h3> <br><
            <input class="form-control" type="text" name="use_point" value="" placeholder="Discount Point"/>
      ...
      <c:if test="${e_point == 1}">
        ...
        <div class="col-sm-6">
             <c:if test="${sessionScope.username != null}">
            <h3> Get Point </h3>&emsp; <h1>${cart.point}</h1>
            </c:if>
        </div>
            <hr class="divider-w">
            <div class="row mt-70">
              <div class="col-sm-5 col-sm-offset-7">
                <div class="shop-Cart-totalbox">
                  ...
                  <button class="btn btn-lg btn-block btn-round btn-d" type="submit">Proceed to Checkout</button></form>
                </div>
                              </form>
