            ...
            <div class="main">
                ...
                <section class="module">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-4">
                                <h4 class="font-alt"> <%=session.getAttribute("username")%>'s Profile </h4> 
                                <hr class="divider-w mb-10">
                                <font size="3">Your current point balance : </font><font size="4">${point}</font>
                                <br><a href="showAddress">Edit Profile</a>
                            </div>
