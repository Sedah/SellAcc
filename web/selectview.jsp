...
<<<<<<< HEAD
    ...
    <body>
            ...
            <c:forEach var="acc" items="${acc_list}">
                ...
                <a href="/SellAcc/viewAcc?id=${acc.acc_id}">${acc.name}</a>
                ${acc.name} <br>  
                ${acc.description} <br>   
                ${acc.price} <br>   
                <img src="${acc.image}"/><br>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <h1 class="module-title font-alt mb-0">${acc.name}</h1>
                            </div>
                        </div>
                    </div>
                </section>
                <section class="module">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="shop-item">
                                    <div class="shop-item-image"><img src= "${acc.image}" alt="${acc.name}"/>
                                       
                                    </div>
                                    <h4 class="shop-item-title font-alt"><a href="#">${acc.name}</a></h4>${acc.price}
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <form action="ProcessSelection">
                                <input class="form-control" type="text" name="quentity" value=""  placeholder="quentity"/> <br><br>
                                <center>
                                <button class="btn btn-border-d btn-circle" type="submit" name ="add" value="Add">
                                    <i class="fa fa-fw">&#xF07A;</i> Add to Cart
                                </button>
                                </center>
                                <input type="hidden" name="acc_id" value=${acc.acc_id} />
                                </form>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="font-alt">Description</h4>
                                <hr class="divider-w mb-10">
                                <h4>${acc.description}</h4>

                            </div>>
                        </div>
                        <div class="row">
                            <div class="col-sm-5">
                                <h4 class="font-alt">Comment</h4>
                                <hr class="divider-w mb-10">
                                <form class="form" action="commServlet" method="POST">
                                    <div class="form-group">
                                        <input class="form-control" id="username" type="text" name="name" placeholder="Name"/>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" id="username" type="text" name="email" placeholder="Email "/> 
                                        Please use the same email address you used to register or purchase.
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control" rows="8" cols="80" name="review" style=" max-width: 100%; 
                                                  max-height: 100%;">
                                        </textarea>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <h4 class="font-alt">Recently Comments</h4>
                                <hr class="divider-w mb-10"><br><br>

                                <c:forEach var="comm" items="${comm_list}">
                                    <h4 class="font-alt"> ${comm.name}</h4> <div align="left"><h6>${comm.date}</h6></div> 
                                    <hr class="divider-w mb-10">
                                    ${comm.review}
                                    <br><br>
                                </c:forEach> 
