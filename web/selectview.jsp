                        ...
                        <div class="row multi-columns-row">
                            ...
                            <c:forEach var="acc"  items="${acc_list}">  
                                <form action="ProcessSelection">
                                    <div class="col-sm-4">
                                        <div class="shop-item">
                                            <a href="/SellAcc/viewAcc?id=${acc.acc_id}" target="_blank"><img src="${acc.image}" alt="${acc.name}" style="width:300px;height:300px;"/></a>


                                            <h4 class="shop-item-title font-alt"><a href="/SellAcc/viewAcc?id=${acc.acc_id}">${acc.name}</a></h4>${acc.price} Bath
                                        </div>
                                    </div>
                                </form>
                            </c:forEach>
