                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <h4>Point receive ${ord_s.recieve_point}</h4>
                                    <h4>Point consume ${ord_s.use_point}</h4>
                                ...
                                <div class="shop-Cart-totalbox">
                                    ...
                                    <table class="table table-striped table-border checkout-table">
                                        <tbody>
                                            ...
                                            <a href="showprofile"<button class="btn btn-lg btn-block btn-round btn-d" type="submit" value="Buy">Back</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
