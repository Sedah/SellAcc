                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <h1 class="module-title font-alt mb-0">Order </h1>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-5 col-sm-offset-1 mb-sm-40">
                                <h4 class="font-alt">Order Complete</h4>
                                <hr class="divider-w mb-10">
                                <form class="form" action="/SellAcc/AccServlet" method="POST">
                                    <H1>Order Complete</H1>
                                    You can see Order No. in your <a href="showprofile">Profile</a><br><br>
                                    <div class="form-group">
                                        <button class="btn btn-block btn-round btn-b" type="submit" value="regis">Next</button>
                                    </div></form>
                            </div>
                            <div class="col-sm-5">
                                <h4 class="font-alt">Credit Card / Debit Cart Service</h4>
                                <hr class="divider-w mb-10">
                                <center><br>
