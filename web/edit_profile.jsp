                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <form class="form" action="editPassword" method="POST">
                                    <div class="form-group">
                                        <input class="form-control" id="username" type="text" name="old_pass" placeholder="Old password"/>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" id="password" type="password" name="new_pass" placeholder="new Password"/>
                                    </div>
                                    <div class="form-group">
                                        <button class="btn btn-round btn-b">Change password</button>
                                    </div>
                            </div>
                                ...
                                <table border="1" class="table table-striped table-border checkout-table">
                                    ...
                                    <form action="deleteAddress">
                                        <c:forEach var="add" items="${addlist}">
                                            ...
                                            <td><input class="btn btn-lg btn-block btn-round btn-d" type="submit" value="delete" /></td>
                                            </tr>
