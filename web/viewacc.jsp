                ...
                <section class="module">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="shop-item">
                                    <div class="shop-item-image"><img src= "${acc.image}" alt="${acc.name}" style="width:300px;height:300px;"/>
                                       
                                    </div>
                                    <h4 class="shop-item-title font-alt"><a href="">${acc.name}</a></h4>${acc.price} Bath
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <form action="ProcessSelection">
                                <input class="form-control" type="text" name="quentity" value="1"  placeholder="quentity"/> <br><br>
                                <center>
