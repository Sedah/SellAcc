        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a  href="login_register.jsp">Login</a></li>
            </ul>
          </div>
        </div>
      </nav>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt">Please insert your address</h1>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-5">
                  ...
                  <div class="form-group">
                      <br><button class="btn btn-b btn-round" type="submit">Submit</button>  &emsp; or &emsp; <a href="login_register.jsp"> Register</a>
                  </div>
                </form>
                </div>
              </div>
