                        ...
                        <div class="row">
                            <form action="paymentServlet" method="post">
                                ...
                                <div class="col-sm-5 col-sm-offset-1 mb-sm-40">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" id="username" type="text" name="time" placeholder="Time (EX. HH:MM:SS)"/>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" id="username" type="text" name="image" placeholder="image URL"/>
                                    </div>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        <br><input class="form-control" id="username" type="text" name="date" placeholder="Date (EX. YYYY-MM-DD)"/>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" id="username" type="text" name="amount" placeholder="Amount"/>
                                    </div>
                                    <div class="row mt-70">
                                        <div class="col-sm-5 col-sm-offset-7">
                                            <button class="btn btn-border-d btn-circle" type="submit" value="submit">Submit</button>
                                        </div>
                                    </div>
                            </form>
                            <c:if test="${payment == 1}">
