 ...
 */
@WebServlet(name = "OrderCheck", urlPatterns = {"/admin/OrderCheck"})
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (employee_name != null) {
                ...
                while (rs.next()) {
                    ...
                    for (int i = 0; i < rsmd.getColumnCount(); i++) {
                        if (rsmd.getColumnName(i + 1).equals("order_id"));
                        out.print("<button class=\"btn btn-b btn-round\" type='submit' label='view' name='view' value='" + rs.getString(1) + "'>view</button><br>");
                        break;
                    }
                    out.print("</form>");
                    out.print("</td>");
